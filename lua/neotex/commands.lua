...
function M.setup()
    ...
    vim.api.nvim_create_user_command("NeoTexCompile", function()
        compiler.compile()
    end, {})

    vim.api.nvim_create_user_command("NeoTexOpen", function()
        pdfviewer.view_pdf()
    end, {})
    ...
    vim.api.nvim_create_user_command("NeoTexForwardSearch", function()
        pdfviewer.forward_search()
    end, {})

    vim.api.nvim_create_user_command("NeoTexLiveToggle", function()
